...
// This file was generated by Copilot from the OpenAPI YAML specification.
...
func (c *Client) GetVersion(ctx context.Context, query url.Values) (*APIVersion, error) {
	resp, err := c.do(ctx, http.MethodGet, "/api/version", query, nil)
	...
	if err := json.Unmarshal(resp, &apiVersion); err != nil {
		return nil, err
	}
...
func (c *Client) GetTransport(ctx context.Context, query url.Values) (*TransportType, error) {
	resp, err := c.do(ctx, http.MethodGet, "/api/transport", query, nil)
	...
	if err := json.Unmarshal(resp, &transport); err != nil {
		return nil, err
	}
